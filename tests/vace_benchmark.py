...
class ComprehensiveBenchmark:
    ...
    def __init__(self, model, device, output_dir="benchmark_results_vace"):
        self.model = model
        self.device = device
    ...
    def benchmark_generation_pipeline(self):
        ...
        generation_configs = [
            ...
            {"frames": 122, "steps": 5, "name": "long_test"},
            {"frames": 250, "steps": 5, "name": "very_long_test"},
            {"frames": 400, "steps": 5, "name": "super_long_test"},
        ...
        for config in generation_configs:
            ...
            try:
                ...
                with self.monitor.monitor(f"Generation_{config['name']}"):
                    ...
                    result_video = self.model.generate(
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='benchmark_results_vace',
    ...
    from vace_test import VaceTester, TestConfig
